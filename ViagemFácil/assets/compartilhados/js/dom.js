const obterCaminhoAudio = (arquivo) => {
  try {
    if (typeof import.meta !== 'undefined' && import.meta.url) {
      return new URL('../audio/' + arquivo, import.meta.url).href;
    }
  } catch (e) {}
  return './assets/compartilhados/audio/' + arquivo;
};

const bipAudio = new Audio(obterCaminhoAudio('bip.mp3'));
const sucessoAudio = new Audio(obterCaminhoAudio('sucesso.mp3'));
const alertaAudio = new Audio(obterCaminhoAudio('alerta.mp3'));
